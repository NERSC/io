...
#### Request a 50GB scratch allocation, striped over BB nodes, in the default pool (which has 20GiB granularity, so this gives you 3 BB nodes)
#DW jobdw capacity=50GB access_mode=striped type=scratch pool=wlm_pool
